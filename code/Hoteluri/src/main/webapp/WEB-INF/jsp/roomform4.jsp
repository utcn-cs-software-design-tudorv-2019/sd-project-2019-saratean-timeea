...
<div class="card-header" style="background:Red">
              <h2 class="text-left my-auto font-weight-light">View room info</h2>
            </div>
<body>
        ...
        <div class="row justify-content-center align-items-center" id="central">
          <div class="card" style="width: 35rem;">
              ...
              <div class="card-body">
                  ...
                  <form:form class="form-signin" method="POST" action="/Hoteluri/readRoom">
                  ...
                  <div class="form-label-group">
                    ...
                    <button class="btn btn-sm btn-default btn-block mt-4" type="submit"  >View room</button>
